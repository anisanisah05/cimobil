...
<table border="1px solid black" style="border-collapse: collapse;">
	...
	<tr>
	<th>no</th><th>Nama Barang</th><th>harga</th><th>jumlah</th><th>sub total</th>
	</tr>
	...
	<td><?= $no?></td><td><?= $dts->nama_barang?></td><td><?= number_format($dts->harga)?></td><td><?= $dts->jumlah?></td><td><?= number_format($dts->harga*$dts->jumlah)?></td>
