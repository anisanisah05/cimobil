	...
	<div class="col-md-7">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>nama_barang</td><td>kategori</td><td>harga</td><td>stok</td><td></td><td></td>
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$no?></td></td><td><?=$bk->nama_barang?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><?=$bk->stok?></td>
...
<table class="table table-stripped table-hover">
	...
	<tr><td colspan="2">Nama Pembeli</td><td colspan="4"><input type="text" name="pembeli" value="<?=$this->session->flashdata('pembeli');?>"></td></tr>
				...
				<th>No</th><th>nama_barang</th><th>Jumlah</th><th>Harga</th><th>Subtotal</th><th></th>
