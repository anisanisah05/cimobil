				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img src="<?= base_url()?>assets/img/MII.png" style="weight:150px; height:150px;"alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">MI CAR</h1>
							<p>We help you to find your dream car</p>
						</div>
					</div>
