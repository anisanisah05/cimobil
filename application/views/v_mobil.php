...
<table class="table table-hover table-stripped">
	...
	<thead>
		...
		<tr>
			...
			<td>no</td><td>kode_barang</td><td>nama_barang</td><td>kategori</td><td>harga</td><td>stok</td><td></td><td></td>
	...
	<tbody>
		...
		<?php $no = 0; foreach($mobil as $bk): $no++;?>
		...
		<tr>
			...
			<td><?=$no?></td><td><?=$bk->kode_barang?></td><td><?=$bk->nama_barang?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><?=$bk->stok?></td>
			...
			<td><?php if($this->session->userdata('level')=="admin"){?><a href="<?=base_url('index.php/mobil/hapus/'.$bk->kode_barang)?>" onclick="return confirm('apakah anda yakin untuk menghapus')" class="btn btn-danger">Hapus</a><?php }else{ echo "anda kasir"; }?></td>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="<?=base_url('index.php/mobil/update')?>" method="post" enctype="multipart/form-data">
